...
.tg .tg-owt4{background-color:#38cf6d;border-color:#000000;color:#000000;font-size:14px;font-weight:bold;text-align:center;
  vertical-align:top}
.tg .tg-3fc6{background-color:#1f1f1f;border-color:inherit;color:#ffffff;font-size:11px;text-align:left;vertical-align:top}
.tg .tg-bykx{background-color:#38cf6d;border-color:#000000;color:#000000;font-size:12px;font-weight:bold;text-align:left;
  vertical-align:middle}
.tg .tg-kwtr{background-color:#38cf6d;border-color:#000000;color:#000000;font-size:12px;font-weight:bold;text-align:left;
  vertical-align:top}
.tg .tg-5fr4{background-color:#1f1f1f;border-color:inherit;color:#ffc745;font-size:11px;text-align:left;vertical-align:top}
.tg .tg-vl9x{background-color:#1f1f1f;border-color:inherit;color:#ffffff;font-size:11px;text-align:left;vertical-align:top}
.tg .tg-ah45{background-color:#1f1f1f;border-color:inherit;color:#ffc745;font-size:11px;text-align:left;vertical-align:top}
</style>
...
<thead>
  <tr>
    <th class="tg-owt4" colspan="3">Ratings.csv</th>
  </tr>
</thead>
<tbody>
  <tr>
    <td class="tg-bykx">Variável        </td>
    <td class="tg-kwtr">Tipo            </td>
    <td class="tg-kwtr">Descrição       </td>
  </tr>
  <tr>
    <td class="tg-5fr4">num</td>
    <td class="tg-vl9x">double</td>
    <td class="tg-vl9x">Número do jogo</td>
  </tr>
  <tr>
    <td class="tg-ah45">id</td>
    <td class="tg-3fc6">double</td>
    <td class="tg-3fc6">ID do jogo</td>
  </tr>
  <tr>
    <td class="tg-5fr4">name</td>
    <td class="tg-vl9x">character</td>
    <td class="tg-vl9x">Nome do jogo</td>
  </tr>
  <tr>
    <td class="tg-ah45">year</td>
    <td class="tg-3fc6">double      </td>
    <td class="tg-3fc6">Ano de lançamento    </td>
  </tr>
  <tr>
    <td class="tg-5fr4">rank</td>
    <td class="tg-vl9x">double</td>
    <td class="tg-vl9x">Ranking </td>
  </tr>
  <tr>
    <td class="tg-ah45">average</td>
    <td class="tg-3fc6">double</td>
    <td class="tg-3fc6">Média</td>
  </tr>
  <tr>
    <td class="tg-5fr4">bayes_average</td>
    <td class="tg-vl9x">double</td>
    <td class="tg-vl9x">Média bayesiana</td>
  </tr>
  <tr>
    <td class="tg-ah45">users_rated</td>
    <td class="tg-3fc6">double</td>
    <td class="tg-3fc6">Total de votações dos usuários</td>
  </tr>
  <tr>
    <td class="tg-5fr4">url</td>
    <td class="tg-vl9x">character</td>
    <td class="tg-vl9x">URL do jogo</td>
  </tr>
  <tr>
    <td class="tg-ah45">thumbnail</td>
    <td class="tg-3fc6">character</td>
    <td class="tg-3fc6">Thumbnail do jogo</td>
  </tr>
</tbody>
</table>
...
.tg th{background-color:#9DE0AD;border-color:#bbb;border-style:solid;border-width:1px;color:#493F3F;
  font-family:Arial, sans-serif;font-size:14px;font-weight:normal;overflow:hidden;padding:10px 5px;word-break:normal;}
.tg .tg-v4yg{background-color:#1f1f1f;border-color:#ffffff;color:#ffc745;font-size:11px;text-align:left;vertical-align:top}
.tg .tg-owt4{background-color:#38cf6d;border-color:#000000;color:#000000;font-size:14px;font-weight:bold;text-align:center;
  vertical-align:top}
.tg .tg-3fc6{background-color:#1f1f1f;border-color:inherit;color:#ffffff;font-size:11px;text-align:left;vertical-align:top}
.tg .tg-bykx{background-color:#38cf6d;border-color:#000000;color:#000000;font-size:12px;font-weight:bold;text-align:left;
...
.tg .tg-kwtr{background-color:#38cf6d;border-color:#000000;color:#000000;font-size:12px;font-weight:bold;text-align:left;
  vertical-align:top}
.tg .tg-vl9x{background-color:#1f1f1f;border-color:inherit;color:#ffffff;font-size:11px;text-align:left;vertical-align:top}
.tg .tg-9wel{background-color:#1f1f1f;border-color:#ffffff;color:#ffc745;font-size:11px;text-align:left;vertical-align:top}
.tg .tg-0fiz{background-color:#1f1f1f;color:#ffc745;font-size:11px;text-align:left;vertical-align:top}
.tg .tg-lp52{background-color:#1f1f1f;color:#ffffff;font-size:11px;text-align:left;vertical-align:top}
.tg .tg-ioye{background-color:#1f1f1f;color:#ffc745;font-size:11px;text-align:left;vertical-align:top}
.tg .tg-3ykh{background-color:#1f1f1f;color:#ffffff;font-size:11px;text-align:left;vertical-align:top}
</style>
...
<thead>
  <tr>
    <th class="tg-owt4" colspan="3">Details.csv</th>
  </tr>
</thead>
<tbody>
  <tr>
  ...
  <tr>
    <td class="tg-v4yg">num</td>
    <td class="tg-vl9x">double</td>
    <td class="tg-vl9x">Número do jogo</td>
  </tr>
  <tr>
    <td class="tg-9wel">id</td>
    <td class="tg-3fc6">double</td>
    <td class="tg-3fc6">ID do jogo</td>
  </tr>
  <tr>
    <td class="tg-v4yg">primary</td>
    <td class="tg-vl9x">character</td>
    <td class="tg-vl9x">Nome do jogo</td>
  </tr>
  <tr>
    <td class="tg-9wel">year published</td>
    <td class="tg-3fc6">double      </td>
    <td class="tg-3fc6">Ano de lançamento    </td>
  </tr>
  <tr>
    <td class="tg-v4yg">min_players</td>
    <td class="tg-vl9x">double</td>
    <td class="tg-vl9x">Número mínimo de jogadores</td>
  </tr>
  <tr>
    <td class="tg-9wel">max_players</td>
    <td class="tg-3fc6">double</td>
    <td class="tg-3fc6">Número máximo de jogadores</td>
  </tr>
  <tr>
    <td class="tg-v4yg">playing_time</td>
    <td class="tg-vl9x">double</td>
    <td class="tg-vl9x">Tempo de jogo em minutos</td>
  </tr>
  <tr>
    <td class="tg-9wel">min_play_time</td>
    <td class="tg-3fc6">double</td>
    <td class="tg-3fc6">Tempo mínimo de jogo em minutos</td>
  </tr>
  <tr>
    <td class="tg-v4yg">max_play_time</td>
    <td class="tg-vl9x">double</td>
    <td class="tg-vl9x">Tempo máximo de jogo em minutos</td>
  </tr>
  <tr>
    <td class="tg-9wel">min_age</td>
    <td class="tg-3fc6">double</td>
    <td class="tg-3fc6">Idade mínima</td>
  </tr>
  <tr>
    <td class="tg-0fiz">board_game_category</td>
    <td class="tg-lp52">character</td>
    <td class="tg-lp52">Categoria</td>
  </tr>
  <tr>
    <td class="tg-ioye">board_game_mechanic</td>
    <td class="tg-3ykh">character</td>
    <td class="tg-3ykh">Mecânica </td>
  </tr>
  <tr>
    <td class="tg-0fiz">board_game_family</td>
    <td class="tg-lp52">character </td>
    <td class="tg-lp52">Família do jogo</td>
  </tr>
  <tr>
    <td class="tg-ioye">board_game_expansion</td>
    <td class="tg-3ykh">character</td>
    <td class="tg-3ykh">Expansão</td>
  </tr>
  <tr>
    <td class="tg-0fiz">board_game_implementation</td>
    <td class="tg-lp52">character</td>
    <td class="tg-lp52">Execução</td>
  </tr>
  <tr>
    <td class="tg-ioye">board_game_designer</td>
    <td class="tg-3ykh">character</td>
    <td class="tg-3ykh">Designer / Criador</td>
  </tr>
  <tr>
    <td class="tg-0fiz">board_game_artist</td>
    <td class="tg-lp52">character</td>
    <td class="tg-lp52">Artista</td>
  </tr>
  <tr>
    <td class="tg-ioye">board_game_publisher</td>
    <td class="tg-3ykh">character</td>
    <td class="tg-3ykh">Editora</td>
  </tr>
  <tr>
    <td class="tg-0fiz">owned</td>
    <td class="tg-lp52">double</td>
    <td class="tg-lp52">Adquiridos</td>
  </tr>
  <tr>
    <td class="tg-ioye">trading</td>
    <td class="tg-3ykh">double</td>
    <td class="tg-3ykh">Comercializados</td>
  </tr>
  <tr>
    <td class="tg-0fiz">wanting</td>
    <td class="tg-lp52">double</td>
    <td class="tg-lp52">Número de usuários que gostariam de adquirir o jogo</td>
  </tr>
  <tr>
    <td class="tg-ioye">wishing</td>
    <td class="tg-3ykh">double</td>
    <td class="tg-3ykh">Número de usuários que desejariam ganhar o jogo</td>
  </tr>
</tbody>
</table>
...
jogos_tabuleiro |>      
  ...
  arrange(rank) |>                                                             # ordenarpor ranking.
  slice_head(n = 20) |>                                                 # vinte primeiros elementos.
  ggplot(aes(
    x = fct_reorder(name, rank, .desc = TRUE),                               # reordenar as colunas.
    y = rank,
    label = round(bayes_average, 2)
  )) +
  geom_segment(aes(                                                      # cria o elemento segmento.
    x = fct_reorder(name, rank, .desc = TRUE),                              
    xend = name,
    y = 0,
    yend = rank
  ),
  ...
  geom_point(aes(color = year),                                           # cria o elemento círculo.
    size = 8.5,
    color = cor                               
  ) +
  geom_label(
