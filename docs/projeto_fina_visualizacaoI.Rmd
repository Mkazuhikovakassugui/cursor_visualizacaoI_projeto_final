...
<div align=justify style="text-indent: 3em;"> Durante a pandemia da covid-19 e em plena era dos jogos digitais, o interesse das pessoas por jogos de mesa e de tabuleiro tem aumentado. Segundo dados da *Euromonitor International*, empresa britânica de pesquisa de mercado,  a combinação de tempo livre e nostalgia fez com que os europeus voltassem a procurá-los. No Brasil, o mercado de brinquedos e jogos tradicionais aumentou de 1% do período pré-pandêmico para 3,16% em 2022.

Este fenômeno tem mexido com as indústrias de "games" e de jogos de mesa e de tabuleiros, tanto que franquias como [*"Assassin's  Creed"*](https://olhardigital.com.br/2022/03/17/games-e-consoles/jogo-de-tabuleiro-de-assassins-creed-sera-lancado-em-2022/) e [*"The Elder Scrolls 5: Skyrim"*](https://canaltech.com.br/games/the-elder-scrolls-5-skyrim-tera-jogo-de-tabuleiro-em-2022-200773/), dois dos mais famosos jogos de console, ambos disponíveis em *Xbox* e *Playstation*, terão suas versões de tabuleiro lançadas em 2022.
...
- as melhores médias na avaliações de usuários;  
- a posição dos jogos no ranking;  
- os mais citados nas listas de desejos e nas listas de procurados;
- a indicação etária e
- os mais comercializados de acordo com a base analisada.  
...
Relacionamos os 20 jogos "solo" **melhores avaliados** entre aqueles com no mínimo 10.000 avaliações.
...
## Os mais desejados e seus *rankings*

<div align=justify style="text-indent: 3em;">Entende-se por jogos mais desejados aqueles em que os avaliadores expressaram a vontade de ganhá-los, ou seja, colocaram-nos em suas *wishlists* (listas de desejos).

O gráfico a seguir apresenta os vinte jogos "solo" **mais desejados**, considerando somente aqueles com mais de 10000 avaliações.
...
<div align=justify style="text-indent: 3em;">A seguir, trazemos os jogos "solo"mais desejados organizados por **categoria**, com duração máxima de 160 minutos e adquiridos por mais de 5000 usuários (legenda amarela). 
...
Para encontrar os jogos "solo" com duração mínima inferior a 160 minutos disponíveis por **faixa etária**, informe a categoria e a idade nos campos abaixo para visualizar quais opções existem entre os mais desejados e suas posições no *ranking* de notas:
...
<div align=justify style="text-indent: 3em;"> Você pode encontrar a descrição completa destes jogos, selecionado o título abaixo:
</div>
            ...
            fluidRow(
                column(
                    ...
                    div(style = "background-color:#ecf4ff;
                        ...
                        width = "850px",  #l argura do texto para ocupar a largura do relatório.
                        align = "l",
                        )
                    )
                ),
...
<div align=justify style="text-indent: 3em;">Realizada a análise dos jogos "solo", por meio das visualizações, podemos observar que nem todos os do topo do *ranking* estão entre os mais desejados.  
...
Sobre o tempo de jogo e faixa etária, aqueles com 4 horas ou mais talvez não sejam a melhor opção para quem quer jogar sozinho e se quem vai jogar é uma criança, deve-se observar a idade mínima. Muitos jogos exigem o raciocínio analítico e o uso de estratégias avançadas, por este motivo os fabricantes informam a idade mínima recomendada.

Neste trabalho encontramos 46 opções de jogos que permitem uma aventura "solo", mas o melhor jogo depende de cada jogador e suas preferências. Esta lista traz apenas alguns dos vários jogos incríveis à disposição.

Em uma era de video games, um jogo de tabuleiro pode ser uma agradável surpresa, então, não espere um apagão para se divertir. 
