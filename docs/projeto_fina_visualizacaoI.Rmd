...
jogos_tabuleiro |>       # filtrar por usuários que avaliaram > 5000 e mínimo de jogadores igual a 1
    ...
    geom_label(
        ...
        color = "#FFFFFF"                                                     # cor do label "preto"
    ) +
    ...
    color = "#C2D9FF"                                                           # cor da linha curva
    ) +
    ...
    theme_classic() +                                   # tema escolhido para o gráfico
    ...
    theme(                                        # otimizamos o gráfico, alterando diversos fatores
        ...
        panel.background = element_rect(fill = "#237CA9"),                         # fundo do painel
        plot.background = element_rect(fill = "#237CA9"),                      # mesmo fundo do plot
